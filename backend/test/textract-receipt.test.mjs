...
test("analyzeReceiptImageBytes: LINE Blocks から店名ヘッダを補完", async () => {
        ...
        Blocks: [
          {
            BlockType: "LINE",
            Text: "うなぎ割烹 竹江",
            Geometry: { BoundingBox: { Left: 0.12, Top: 0.06, Width: 0.46, Height: 0.05 } },
          },
          {
            BlockType: "LINE",
            Text: "TEL 048-283-8812",
            Geometry: { BoundingBox: { Left: 0.13, Top: 0.12, Width: 0.34, Height: 0.02 } },
          },
        ],
      }),
    }),
