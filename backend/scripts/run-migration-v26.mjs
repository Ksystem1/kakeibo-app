/**
 * RDS に db/migration_v26_passkey_foundation.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v26
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v26_passkey_foundation.sql");
...
try {
  ...
  console.log("migration_v26_passkey_foundation.sql の適用が完了しました。");
} finally {
  await conn.end();
}
