/**
 * RDS に db/migration_v24_paypay_import.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v24
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v24_paypay_import.sql");
...
try {
  ...
  console.log("migration_v24_paypay_import.sql の適用が完了しました。");
} finally {
  await conn.end();
}
