/**
 * v41: user_store_places.preferred_category_id
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v41_user_store_places_learned_category.sql",
);
...
try {
  ...
  console.log("migration_v41_user_store_places_learned_category.sql の適用が完了しました。");
} finally {
