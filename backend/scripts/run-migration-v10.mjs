/**
 * RDS に db/migration_v10_users_stripe_customer_id.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v10
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v10_users_stripe_customer_id.sql",
);
...
try {
  ...
  console.log("migration_v10_users_stripe_customer_id.sql の適用が完了しました。");
} finally {
  await conn.end();
}
