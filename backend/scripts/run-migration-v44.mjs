/**
 * v44: users.last_access_user_agent
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v44_users_last_access_user_agent.sql");
...
try {
  ...
  console.log("migration_v44_users_last_access_user_agent.sql の適用が完了しました。");
} finally {
