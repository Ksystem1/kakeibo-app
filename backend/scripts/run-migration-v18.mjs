/**
 * RDS に db/migration_v18_users_family_role.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v18
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v18_users_family_role.sql");
...
try {
  ...
  console.log("migration_v18_users_family_role.sql の適用が完了しました。");
} finally {
  await conn.end();
}
