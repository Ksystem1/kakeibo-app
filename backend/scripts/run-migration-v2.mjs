/**
 * RDS に db/migration_v2_auth_families.sql を適用する。
 * 実行: cd backend && node scripts/run-migration-v2.mjs
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v2_auth_families.sql",
);
...
try {
  ...
  console.log("migration_v2_auth_families.sql の適用が完了しました。");
} finally {
  await conn.end();
}
