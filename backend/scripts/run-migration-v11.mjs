/**
 * RDS に db/migration_v11_users_subscription_period.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v11
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v11_users_subscription_period.sql",
);
...
try {
  ...
  console.log("migration_v11_users_subscription_period.sql の適用が完了しました。");
} finally {
  await conn.end();
}
