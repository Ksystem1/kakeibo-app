/**
 * RDS に db/migration_v22_chat_read_and_edit.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v22
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v22_chat_read_and_edit.sql");
...
try {
  ...
  console.log("migration_v22_chat_read_and_edit.sql の適用が完了しました。");
} finally {
  await conn.end();
}
