/**
 * RDS に db/migration_v16_static_chain_store_category_hints.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v16
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v16_static_chain_store_category_hints.sql",
);
...
try {
  ...
  console.log("migration_v16_static_chain_store_category_hints.sql の適用が完了しました。");
} finally {
  await conn.end();
}
