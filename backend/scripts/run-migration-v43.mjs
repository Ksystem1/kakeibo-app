/**
 * v43: receipt_processing_jobs（非同期レシート解析）
 * 実行: cd backend && npm run db:migrate-v43
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v43_receipt_processing_jobs.sql",
);
...
try {
  ...
  console.log("migration_v43_receipt_processing_jobs.sql の適用が完了しました。");
} finally {
