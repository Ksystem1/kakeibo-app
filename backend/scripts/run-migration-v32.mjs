/**
 * v32: feature_permissions（プラン別機能権限）
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v32_feature_permissions.sql");
...
try {
  ...
  console.log("migration_v32_feature_permissions.sql の適用が完了しました。");
} finally {
