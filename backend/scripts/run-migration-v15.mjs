/**
 * RDS に db/migration_v15_global_receipt_ocr_corrections.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v15
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v15_global_receipt_ocr_corrections.sql",
);
...
try {
  ...
  console.log("migration_v15_global_receipt_ocr_corrections.sql の適用が完了しました。");
} finally {
  await conn.end();
}
