/**
 * RDS に db/migration_v20_users_kid_theme.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v20
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v20_users_kid_theme.sql");
...
try {
  ...
  console.log("migration_v20_users_kid_theme.sql の適用が完了しました。");
} finally {
  await conn.end();
}
