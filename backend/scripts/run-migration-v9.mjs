/**
 * RDS に db/migration_v9_users_is_premium.sql を適用する（任意列）。
 * 実行: cd backend && npm run db:migrate-v9
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v9_users_is_premium.sql",
);
...
try {
  ...
  console.log("migration_v9_users_is_premium.sql の適用が完了しました。");
} finally {
  await conn.end();
}
