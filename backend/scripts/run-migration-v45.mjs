...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v45_receipt_learning_catalog.sql");
...
try {
  ...
  console.log("migration_v45_receipt_learning_catalog.sql の適用が完了しました。");
} finally {
