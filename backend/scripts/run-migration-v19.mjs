/**
 * RDS に db/migration_v19_chat_messages_chat_scope.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v19
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v19_chat_messages_chat_scope.sql");
...
try {
  ...
  console.log("migration_v19_chat_messages_chat_scope.sql の適用が完了しました。");
} finally {
  await conn.end();
}
