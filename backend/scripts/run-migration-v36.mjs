/**
 * v36: feature_permissions のプラン切り分けを更新
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v36_feature_permission_plan_split.sql",
);
...
try {
  ...
  console.log("migration_v36_feature_permission_plan_split.sql の適用が完了しました。");
} finally {
