...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v33_users_last_accessed_at.sql");
...
try {
  ...
  console.log("migration_v33_users_last_accessed_at.sql の適用が完了しました。");
} finally {
