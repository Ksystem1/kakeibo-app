/**
 * RDS に db/migration_v7_family_fixed_costs.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v7
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v7_family_fixed_costs.sql",
);
...
try {
  ...
  console.log("migration_v7_family_fixed_costs.sql の適用が完了しました。");
} finally {
  await conn.end();
}
