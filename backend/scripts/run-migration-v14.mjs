/**
 * RDS に db/migration_v14_chat_messages.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v14
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v14_chat_messages.sql",
);
...
try {
  ...
  console.log("migration_v14_chat_messages.sql の適用が完了しました。");
} finally {
  await conn.end();
}
