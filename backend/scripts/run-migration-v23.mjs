/**
 * RDS に db/migration_v23_child_profiles.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v23
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v23_child_profiles.sql");
...
try {
  ...
  console.log("migration_v23_child_profiles.sql の適用が完了しました。");
} finally {
  await conn.end();
}
