/**
 * RDS に db/migration_v13_site_settings_header_announcement.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v13
 * 接続: backend/.env の RDS_HOST, RDS_PORT, RDS_USER, RDS_PASSWORD, RDS_DATABASE
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v13_site_settings_header_announcement.sql",
);
...
try {
  ...
  console.log("migration_v13_site_settings_header_announcement.sql の適用が完了しました。");
} finally {
  await conn.end();
}
