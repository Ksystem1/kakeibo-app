/**
 * RDS に db/migration_v25_monitor_recruitment_settings.sql を適用する。
 * 実行: cd backend && npm run db:migrate-v25
 */
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v25_monitor_recruitment_settings.sql");
...
try {
  ...
  console.log("migration_v25_monitor_recruitment_settings.sql の適用が完了しました。");
} finally {
  await conn.end();
}
