/**
 * v35: feature_permissions に medical_deduction_csv を追加
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v35_feature_permission_medical_deduction_csv.sql",
);
...
try {
  ...
  console.log("migration_v35_feature_permission_medical_deduction_csv.sql の適用が完了しました。");
} finally {
