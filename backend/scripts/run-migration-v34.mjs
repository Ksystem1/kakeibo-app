/**
 * v34: カテゴリの医療費既定 + 取引の医療費項目を追加
 * 実行: cd backend && npm run db:migrate-v34
 */
...
const migrationPath = path.resolve(
  ...
  "..",
  "db",
  "migration_v34_medical_defaults_and_transaction_fields.sql",
);
...
try {
  ...
  console.log("migration_v34_medical_defaults_and_transaction_fields.sql の適用が完了しました。");
} finally {
