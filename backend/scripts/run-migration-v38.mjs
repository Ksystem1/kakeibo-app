/**
 * v38: sales_logs の stripe_source_type に refund を追加
...
const migrationPath = path.resolve(__dirname, "..", "..", "db", "migration_v38_sales_logs_refund_enum.sql");
...
try {
  ...
  console.log("migration_v38_sales_logs_refund_enum.sql の適用が完了しました。");
} finally {
